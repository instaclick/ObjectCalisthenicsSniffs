...
/**
 * ObjectCalisthenics_Sniffs_ControlStructures_OneIndentationLevelSniff.
 *
 ...
 * @link     https://github.com/instaclick/ObjectCalisthenics
 */
class ObjectCalisthenics_Sniffs_ControlStructures_OneIndentationLevelSniff implements PHP_CodeSniffer_Sniff
{
    /**
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        $visitor = new ObjectCalisthenics_Sniffs_ControlStructures_OneIndentationLevelSniff_NodeVisitor;
